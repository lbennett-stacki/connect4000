...
export function initRender({
  ...
  const transformationMatrix = createTransformationMatrix(aspectRatio, camera);
  ...
  return { projectionMatrix, grid, coin, mouse };
}
...
function updateProjectionMatrix(
  ...
  const projectionMatrix = createProjectionMatrix(aspectRatio, scale);
